...
commands=(
  ...
  "python train.py --n_baseline 100 --n_shots 0 --few_shot_cosmological_parameters 'Omega_m' 'Omega_b' 'h' 'n_s' 'sigma_8' 'w' --run_name 'from_scratch_small_w'"
  ...
  "python train.py --n_baseline 2_000 --n_shots 0 --few_shot_cosmological_parameters 'Omega_m' 'Omega_b' 'h' 'n_s' 'sigma_8' 'w' --run_name 'from_scratch_all_w'"
)
